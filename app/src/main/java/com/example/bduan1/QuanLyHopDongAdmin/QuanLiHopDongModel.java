...
public class QuanLiHopDongModel {
    ...
    public QuanLiHopDongModel() {
    }

    public QuanLiHopDongModel(String tenKhachHang, String emailKhachHang, String cccd,String soNguoi,
    ...
    public QuanLiHopDongModel(String tenKhachHang, String emailKhachHang, String cccd, String soNguoi, String ngayBatDau,String ngayKetThuc,String tienCoc) {
        this.tenKhachHang = tenKhachHang;
        this.emailKhachHang = emailKhachHang;
        this.cccd = cccd;
        this.soNguoi = soNguoi;
