...
import com.example.bduan1.ThongBaoAdmin.ThongBaoModel;

import java.util.List;

public class NotificationAdapter_user extends RecyclerView.Adapter<NotificationAdapter_user.NotificationViewHolder> {
    private List<ThongBaoModel> listNotifi;
    private Context context;

    public NotificationAdapter_user(List<ThongBaoModel> listNotifi, Context context) {
    ...
    public void onBindViewHolder(@NonNull NotificationViewHolder holder, int position) {
        ThongBaoModel notifi = listNotifi.get(position);
